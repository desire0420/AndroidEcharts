...
public class ChartPieView extends LinearLayout {
    private WebView mWebview;
    private String jsPie;
    ...
    public ChartPieView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(context).inflate(R.layout.layout_chart_container, this);
        mWebview = findViewById(R.id.chartshow_wb);
        initWebView();
    ...
    public void createPieChart(final JSONObject lineJson) {
        jsPie = "javascript:createChart(" + lineJson + ")";
        mWebview.loadUrl("file:///android_asset/echart/pieChart.html");
